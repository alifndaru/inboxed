<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
        <img src="{{asset("storage/logos/logo-inboxed-logo.png")}}" alt="logo" class="img-logo" height="25">
        <img class="navbar-brand-minimized" src="{{asset('storage/logos/logo-kecil.png')}}" height="30" alt="Square Logo">
    </a>
